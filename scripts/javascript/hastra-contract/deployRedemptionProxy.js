...
async function main() {
    ...
    console.log("Deploying RedemptionProxy implementation with the account:", deployer.address);
...
🚀 Success! RedemptionProxy implementation deployed to: ${implementationAddress}`);
    console.log(`Next step: Set this address in the DedicatedVaultRouter using updateDedicatedVaultRouter.js`);
}
