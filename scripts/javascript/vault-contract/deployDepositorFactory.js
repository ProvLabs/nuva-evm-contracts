...
async function main() {
  ...
  console.log(
    "✅ Depositor implementation deployed to:",
  ...
  if (event) {
    ...
    depositorAddress = parsedLog.args[2]; // Third argument is the depositor address
  ...
  if (code === "0x") {
    throw new Error(
      "No code at the deployed address. Contract deployment may have failed.",
    );
  }
