...
async function main() {
    ...
    try {
        ...
        if (error.data && error.data.includes("d1cc7385")) {
            ...
            console.error("This confirms the CustomToken contract is not the one you provided.");
        } else {
            console.error("\n*** DEBUGGER: The 'permit' function reverted with a DIFFERENT error. ***");
            console.error("This likely means your signature is invalid (e.g., wrong nonce, version, etc.)");
        }
